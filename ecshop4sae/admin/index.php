...
//            $warning[] = sprintf($_LANG['temp_dir_cannt_read'], $upload_tmp_dir);
    ...
    $result = file_mode_info(saestor('cert'));;
    if ($result < 2)
    {
//        $warning[] = sprintf($_LANG['not_writable'], 'cert', $_LANG['cert_cannt_write']);
    }

    $result = file_mode_info(saestor(DATA_DIR));
    if ($result < 2)
    {
